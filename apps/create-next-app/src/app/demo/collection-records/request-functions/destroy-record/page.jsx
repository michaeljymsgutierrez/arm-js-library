...
const Page = observer(() => {
  ...
  if (ARM.isNil(address)) return <div>Address has been deleted.</div>
  ...
  return (
    <form onSubmit={(event) => event.preventDefault()}>
      ...
      <div className="form-control">
        <button className="blue-btn" onClick={() => address.destroyRecord()}>
          {address.get('isLoading') ? 'Deleting' : 'Delete'}
        </button>
      </div>
    </form>
  )
