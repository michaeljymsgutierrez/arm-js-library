(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("axios"), require("lodash"), require("mobx"), require("uuid"), require("crypto-js")) : typeof define === "function" && define.amd ? define(["axios", "lodash", "mobx", "uuid", "crypto-js"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global["arm-js-library"] = factory(global.axios, global._, global.mobx, global.uuid, global.CryptoJS));
})(this, function(axios, _, mobx, uuid, CryptoJS) {
  "use strict";
  ...
  const mobx__namespace = /* @__PURE__ */ _interopNamespaceDefault(mobx);
  /**
   ...
   */
  const { makeObservable, observable, action, toJS } = mobx__namespace;
  const {
    get: getProperty,
    set: setProperty,
    find,
...
Fix: Try adding ${collectionName} on your ARM config initialization.`;
     ...
     */
    _generateHashId(object = { id: uuid.v1() }) {
    ...
    createRecord(collectionName, collectionRecord = {}, collectionRecordRandomId = true) {
      const collectionRecordId = collectionRecordRandomId ? uuid.v1() : uuid.NIL;
