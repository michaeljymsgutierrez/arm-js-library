    ...
    * **getCollection(collectionName, collectionConfig)**
        ...
        * Passed arguments:
            ...
            * **collectionConfig - Object**                 
                ...
                * **config - Object**
                    * Contains request config such as `(skip, alias, autoResolve, ignorePayload, override)` which are currently available.See example [here](https://github.com/michaeljymsgutierrez/arm-js-library/tree/main/apps/create-next-app/src/app/demo/collection-records/request-functions/get-collection)
